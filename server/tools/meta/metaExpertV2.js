...
registerTool({
  ...
  parameters: {
    ...
    properties: {
      ...
      creative_strategy: { type: "object", properties: { source: { type: "string", enum: INTERNAL_STRATEGY_SCHEMA.properties.creative_strategy.properties.source.enum }, description: { type: "string" } } },
